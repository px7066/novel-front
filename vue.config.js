...
const name = defaultSettings.title || 'novel' // page title
...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API + '/md-login-api']: {
      ...
      [process.env.VUE_APP_BASE_API + '/md-blog-api']: {
      ...
      [process.env.VUE_APP_BASE_API + '/md-resource-api']: {
        target: `http://127.0.0.1:${resourcePort}`,
        changeOrigin: true,
        pathRewrite: {
          ['^' + process.env.VUE_APP_BASE_API]: ''
        }
